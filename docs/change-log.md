...
- 线上（2026-08-15）：work_day 未来日历预置至 12-31；对账清理 5866 行且"有行情但不在日历"=0 无误删；
  物化 1516s rc=0，周线水位 20260814（600519 本周 bar 生成、停牌股按各自最后交易日入表），
  月 20260731 / 季 20260630 不变；`/kdj/periods` 周线最新=08-10~08-14，默认与指定本周扫描均 200 无 Not-Ready
  （详见回归用例 R-20260815-02~12）。
